                ...
                <table cellspacing="0">
                    ...
                    @foreach ($table as $_table)
                        <tr>
                            ...
                            <td><button class="smallButton"
                                    style="background-color:#4CAF50; border:none; padding:0 10px; color:white;">{{ $_table->populariteit }}
                                    %</button></td>
                            <td>€ {{ $_table->omzet }}</td>
                            <td><button class="smallButton"
                                    style="background-color:#2196F3; border:none; padding:0 10px; color:white;">{{ $_table->percentageTotaal }}
                                    %</button></td>
                        </tr>
                    @endforeach
                </table>
